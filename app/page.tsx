      ...
      >
        <div className='container flex h-16 items-center justify-between'>
          ...
          >
            ...
            <div className='font-bold text-xl'>Abrar Fahim</div>
          </motion.div>
              ...
              >
                <Card className='group overflow-hidden border-none shadow-lg hover:shadow-xl transition-all duration-300 h-full flex flex-col'>
                  ...
                  <CardContent className='p-4 sm:p-6 flex flex-col flex-1'>
                    ...
                    <p className='text-muted-foreground text-sm sm:text-base mb-4 line-clamp-6'>
                      Hot-Tube-Cinema is a robust and scalable RESTful API built for a
                      modern movie streaming platform. It features secure
                      authentication, efficient content management, and streamlined
                      user interaction capabilities—designed to power dynamic,
            ...
            <FadeIn direction='up' delay={0.1}>
              <div className='space-y-4'>
                ...
                <div className='flex items-center gap-4'>
                  ...
                  <motion.a
                    href='mailto:engr.abrarfahim@gmail.com'
                    target='_blank'
                    className='text-muted-foreground hover:text-foreground transition-colors'
                    whileHover={{ scale: 1.2, rotate: 5 }}
                    whileTap={{ scale: 0.9 }}
